  ...
  return (
    <StyledDBLink aria-label="dashboard" filled={isDashboardPage}>
      <Link aria-label="got to dashboard" href="/dashboard">
        <svg
          aria-labelledby="dbTitle dbDesc"
          width="40"
          height="40"
          viewBox="0 0 24 24"
          fill="none"
        ...
        >
          <title id="dbTitle">Outlined dashboard Button</title>
          <desc id="dbDesc">
            An illustrated dashboard button displayed as a simple chart with
            dark lines and a white background
          </desc>
          <path
