  ...
  return (
    <StyledHomeLink aria-label="home" filled={isHomePage}>
      <Link aria-label="go to homepage" href={"/"}>
        <svg
          aria-labelledby="homeTitle homeDesc"
          width="40"
          height="40"
          viewBox="0 0 24 24"
          fill="none"
        ...
        >
          <title id="homeTitle">Outlined House Button</title>
          <desc id="homeDesc">
            An illustrated home button displayed as a house with dark lines and
            a white background
          </desc>
          <path
